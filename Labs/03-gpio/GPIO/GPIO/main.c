...
#define LED_RED     PB4     // AVR pin where red LED is connected
#define BUTTON0     PD0     // AVR pin where button is connected
...
int main(void)
{
    ...
    /* push button */
    GPIO_config_input_pullup(&DDRD, BUTTON0);
	
    // Infinite loop
    while (1)
    {
		if (!GPIO_read(&PIND,BUTTON0)) {
